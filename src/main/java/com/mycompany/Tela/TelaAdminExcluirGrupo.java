 ...
 * @author gutinho
 */
public class TelaAdminExcluirGrupo extends javax.swing.JFrame {

    /**
     * Creates new form TelaAdminExcluirGrupo
     */
    public TelaAdminExcluirGrupo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Código do grupo:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String codGrupo = txtCodigo.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAdminExcluirGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAdminExcluirGrupo().setVisible(true);
            }
        });
    }
